...
from backend.models.models import GoalsTasks, Goals, GoalsTasksStatusEnum, Users, GoalsStatusEnum
from backend.repository.repository import GoalTaskRepository, GoalRepository, UserRepository, StatusUnchangedError
...
class TestGoalTasks(TestBase):
    ...
    def test_create_goal_task_with_1_goal_task_name(self):
        ...
        self.assertEqual(goal_tasks[0].goal_task_name, goal_task_data[0].goal_task_name)
    ...
    def test_default_goal_task_status_is_applied(self):
        ...
        goal_tasks = self.goal_task_repository.register_goal_task(self.db, goal_task_data, commit=True)
        self.assertEqual(goal_tasks[0].goal_task_status, GoalsTasksStatusEnum.Todo.value)
    ...
    def test_goal_task_in_progress_status_enum_is_applied(self):
        ...
        goal_tasks = self.goal_task_repository.register_goal_task(self.db, goal_task_data, commit=True)
        self.assertEqual(goal_tasks[0].goal_task_status, GoalsTasksStatusEnum.InProgress.value)
    ...
    def test_goal_task_completed_status_enum_is_applied(self):
        ...
        goal_tasks = self.goal_task_repository.register_goal_task(self.db, goal_task_data, commit=True)
        self.assertEqual(goal_tasks[0].goal_task_status, GoalsTasksStatusEnum.Completed.value)
    ...
    def test_create_goal_task_with_datetime_deadline(self):
        ...
        goal_tasks = self.goal_task_repository.register_goal_task(self.db, goal_task_data, commit=True)
        self.assertEqual(goal_tasks[0].deadline, datetime.date(2030, 10, 15))
    ...
    def test_create_goal_task_with_valid_deadline(self):
        ...
        goal_tasks = self.goal_task_repository.register_goal_task(self.db, goal_task_data, commit=True)
        self.assertEqual(goal_tasks[0].deadline, goal_task_data[0].deadline)
    ...
    def test_create_goal_task_with_estimated_time_lower_boundary(self):
        ...
        goal_tasks = self.goal_task_repository.register_goal_task(self.db, goal_task_data, commit=True)
        self.assertEqual(goal_tasks[0].estimated_time, goal_task_data[0].estimated_time)
    ...
    def test_delete_goal_task_from_db(self):
        ...
        result = self.db.query(GoalsTasks).filter_by(goal_task_id=goal_tasks[0].goal_id).first()
    ...
    def test_update_goal_task_status_to_completed_from_db(self):
        ...
        goal_tasks = self.goal_task_repository.register_goal_task(self.db, goal_task_data, commit=True)
        for task in goal_tasks:
            self.goal_task_repository.update_goal_task_status_from_db(self.db, task.goal_task_id,
