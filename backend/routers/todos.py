...
from schemas import GoalsTasksRequest, GoalsTasksOut, GoalsTasksListOut
from ..models import Goals, GoalsTasks
from openai import OpenAI
import os
import json
from ..repository import registerGoalAndGoalTasks
...
def save_goal_tasks(goalTasksRequest: GoalsTasksRequest,db: Session = Depends(get_db)):
    ...
    registerGoalAndGoalTasks(db, goal, goal_tasks)