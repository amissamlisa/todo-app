...
export const PasswordInput = memo(({ textColor, borderColor, children, formName, handleValueChange}: InputProps) => {
  ...
  return (
    <div className="flex relative flex-col w-[clamp(93px,68vw,400px)]">
      ...
      <input onChange={handleInputChange} className={`${borderColor} focus:outline-none 
