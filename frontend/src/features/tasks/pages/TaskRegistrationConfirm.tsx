...
import { useTaskRegistrationConfirm } from "../hooks/useTaskRegistrationConfirm";
      ...
      <div className="bg-secondary flex flex-col items-center ">
        ...
        <div className="mt-[clamp(20px,4.7vh,80px)] mb-24.5">
          <TwoButton
            ...
            onPrimaryClick={handleSaveGoalTasks}
            onSecondaryClick={handleNavigateRegistration}
          />
        </div>
      </div>
    </div>
