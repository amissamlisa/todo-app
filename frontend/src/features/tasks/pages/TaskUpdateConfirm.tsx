  ...
  return (
    <div className="overflow-y-auto h-screen">
      ...
      <div className="bg-secondary flex flex-col items-center ">
        <p
          className={`text-primary font-bold text-center mt-[clamp(14px,3.3vh,56px)] mb-[clamp(7px,1.6vh,28px)]`}
        >
          達成目標
        </p>
        <div
          className={`text-secondary bg-primary rounded-[5px] overflow-y-auto pl-[4vw] pr-[4vw] h-[clamp(25px,5.9vh,100px)] w-[clamp(163.5px,84vw,654px)] mb-[clamp(10.5px,2.4vh,42px)] flex items-center justify-center text-center`}
        >
          <p>{goalName}</p>
        </div>
